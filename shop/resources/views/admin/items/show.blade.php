        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            <div class="card mt-4">
              ...
              <a href="{{ asset('/storage/').'/'.$item->foto1 ?? '' }}"> <img  class="img-thumbnail shadow-lg img-fluid mx-auto d-block" src="{{ asset('/storage/').'/'. $item->foto1 }}" alt="card"  width="500" >  </a>
              <div class="card-body">
                ...
                <p class="card-text">Registration Type -{{  $item->Rtype}}</p>
                 <form action="{{ route('admin.items.destroy',$item) }}" method="POST">
				  ...
				  @method('delete')
				   ...
				   <a href="{{ route('admin.items.edit', $item) }}" class="btn btn-primary">Edit</a>
